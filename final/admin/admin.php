            ...
            try {
                ...
                events.forEach(event => {
                    ...
                    row.innerHTML = `
                        ...
                        <td><button onclick="openPopup('edit_event.php?event_id=${event.event_id}')">Edit</button></td>
                    `;
...
function closePopup() {
    ...
    <style>
 body {
            font-family: "Hudson NY Pro", Arial, sans-serif;
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        <div class="dashboard">
            <div class="card-container">
                <div class="card" onclick="openPopup('uploadCSV.php')">
            ...
            <div class="card-container">
                <a href="addVenue.php" class="card">
                    <img src="images/addVenue.png" alt="Add Venue">
                    <h3>Add Venue</h3>
                </a>
            </div>

            <div class="card-container">
                <a href="viewData.php" class="card">
            ...
            <div class="card-container">
                <a href="validateEvents.php" class="card">
